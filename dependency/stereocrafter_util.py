...
def get_vram_config(force_refresh: bool = False):
    ...
    if 'rtx 3060' in gpu_name and effective_vram_gb >= 10:
    ...
    elif effective_vram_gb >= 90:  # RTX Pro 6000 / 6000 WS (96GB)
        logger.info("✓ Selected: 96GB tier (RTX Pro 6000 — maximum speed optimization)")
        logger.info(f"  window_size: 200, overlap: 6")
        config = {
            ...
            'processing_chunk_size': 200
        }
    elif effective_vram_gb >= 40:  # RTX 6000 Ada (48GB)
    ...
    elif effective_vram_gb >= 30:  # RTX 5090 (32GB)
        ...
        logger.info(f"  window_size: 80, overlap: 6")
        config = {
